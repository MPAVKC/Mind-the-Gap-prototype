package gButtons 
{
	...
	public class EndButton extends Button 
	{
		...
		public function EndButton(x:Number = 0, y:Number = 0, text:String = "", width:Number=40, height:Number=40, callback:Function=null, params:Object=null) 
		{
		...
		protected function drawButton():void
		{
			...
			g.lineStyle(3, 0xFFFFFF , 1, false, "normal", CapsStyle.NONE, JointStyle.MITER);
			g.drawRect(0, 0, width, height);
		...
		protected function drawLabel(text:String):void
		{
			...
			var tf:TextFormat = new TextFormat("Comfortaa", 18, currentPage ? 0x000000 : 0xFFFFFF);
			tf.align = "center";
